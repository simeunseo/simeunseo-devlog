const CONFIG = {
  ...
  profile: {
    ...
    bio: "문서화를 통한 '스스로와의 질의응답'을 좋아합니다.\n개발 과정에서 실시간으로 문서화하며 끊임없이 더 나은 방법을 고민합니다.\n단순히 결과를 기록하는 것이 아닌, '왜 이 기술을 써야 하는가?', '더 나은 방법은 없는가?' 와 같은 질문을 던지며 의사결정 과정을 체계화합니다.\n이를 통해 얻은 인사이트를 팀원들과 공유하며 시야를 넓히는 시간을 좋아합니다.",
